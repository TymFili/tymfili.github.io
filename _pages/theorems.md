...
For any propositional variable $$p$$, define $$\mathcal{I}(p) = \True \iff p \in \Delta$$. By structural induction on formulae, the extended interpretation $$\hat{\mathcal{I}}$$ satisfies $$\Delta$$, and thus satisfies $$\Sigma \subseteq \Delta$$.
